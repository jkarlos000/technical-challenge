...
type FakeCurrency_GetPriceStreamServer struct {
	...
	SendStub        func(*v1.Response) error
...
func (fake *FakeCurrency_GetPriceStreamServer) Context() context.Context {
...
func (fake *FakeCurrency_GetPriceStreamServer) ContextCallCount() int {
	fake.contextMutex.RLock()
	defer fake.contextMutex.RUnlock()
	return len(fake.contextArgsForCall)
}

func (fake *FakeCurrency_GetPriceStreamServer) ContextCalls(stub func() context.Context) {
	fake.contextMutex.Lock()
	defer fake.contextMutex.Unlock()
	fake.ContextStub = stub
}

func (fake *FakeCurrency_GetPriceStreamServer) ContextReturns(result1 context.Context) {
	fake.contextMutex.Lock()
	defer fake.contextMutex.Unlock()
...
func (fake *FakeCurrency_GetPriceStreamServer) ContextReturnsOnCall(i int, result1 context.Context) {
	fake.contextMutex.Lock()
	defer fake.contextMutex.Unlock()
	fake.ContextStub = nil
...
func (fake *FakeCurrency_GetPriceStreamServer) RecvMsg(arg1 interface{}) error {
...
func (fake *FakeCurrency_GetPriceStreamServer) RecvMsgCallCount() int {
	fake.recvMsgMutex.RLock()
	defer fake.recvMsgMutex.RUnlock()
	return len(fake.recvMsgArgsForCall)
}

func (fake *FakeCurrency_GetPriceStreamServer) RecvMsgCalls(stub func(interface{}) error) {
	fake.recvMsgMutex.Lock()
	defer fake.recvMsgMutex.Unlock()
	fake.RecvMsgStub = stub
}

func (fake *FakeCurrency_GetPriceStreamServer) RecvMsgArgsForCall(i int) interface{} {
	fake.recvMsgMutex.RLock()
	defer fake.recvMsgMutex.RUnlock()
...
func (fake *FakeCurrency_GetPriceStreamServer) RecvMsgReturns(result1 error) {
	fake.recvMsgMutex.Lock()
	defer fake.recvMsgMutex.Unlock()
...
func (fake *FakeCurrency_GetPriceStreamServer) RecvMsgReturnsOnCall(i int, result1 error) {
	fake.recvMsgMutex.Lock()
	defer fake.recvMsgMutex.Unlock()
	fake.RecvMsgStub = nil
...
func (fake *FakeCurrency_GetPriceStreamServer) Send(arg1 *v1.Response) error {
	fake.sendMutex.Lock()
...
func (fake *FakeCurrency_GetPriceStreamServer) SendCallCount() int {
	fake.sendMutex.RLock()
	defer fake.sendMutex.RUnlock()
	return len(fake.sendArgsForCall)
}

func (fake *FakeCurrency_GetPriceStreamServer) SendCalls(stub func(*v1.Response) error) {
	fake.sendMutex.Lock()
	defer fake.sendMutex.Unlock()
	fake.SendStub = stub
}

func (fake *FakeCurrency_GetPriceStreamServer) SendArgsForCall(i int) *v1.Response {
	fake.sendMutex.RLock()
	defer fake.sendMutex.RUnlock()
...
func (fake *FakeCurrency_GetPriceStreamServer) SendReturns(result1 error) {
	fake.sendMutex.Lock()
	defer fake.sendMutex.Unlock()
	fake.SendStub = nil
...
func (fake *FakeCurrency_GetPriceStreamServer) SendReturnsOnCall(i int, result1 error) {
	fake.sendMutex.Lock()
	defer fake.sendMutex.Unlock()
	fake.SendStub = nil
...
func (fake *FakeCurrency_GetPriceStreamServer) SendHeader(arg1 metadata.MD) error {
...
func (fake *FakeCurrency_GetPriceStreamServer) SendHeaderCallCount() int {
	fake.sendHeaderMutex.RLock()
	defer fake.sendHeaderMutex.RUnlock()
	return len(fake.sendHeaderArgsForCall)
}

func (fake *FakeCurrency_GetPriceStreamServer) SendHeaderCalls(stub func(metadata.MD) error) {
	fake.sendHeaderMutex.Lock()
	defer fake.sendHeaderMutex.Unlock()
	fake.SendHeaderStub = stub
}

func (fake *FakeCurrency_GetPriceStreamServer) SendHeaderArgsForCall(i int) metadata.MD {
	fake.sendHeaderMutex.RLock()
	defer fake.sendHeaderMutex.RUnlock()
...
func (fake *FakeCurrency_GetPriceStreamServer) SendHeaderReturns(result1 error) {
	fake.sendHeaderMutex.Lock()
	defer fake.sendHeaderMutex.Unlock()
...
func (fake *FakeCurrency_GetPriceStreamServer) SendHeaderReturnsOnCall(i int, result1 error) {
	fake.sendHeaderMutex.Lock()
	defer fake.sendHeaderMutex.Unlock()
	fake.SendHeaderStub = nil
...
func (fake *FakeCurrency_GetPriceStreamServer) SendMsg(arg1 interface{}) error {
...
func (fake *FakeCurrency_GetPriceStreamServer) SendMsgCallCount() int {
	fake.sendMsgMutex.RLock()
	defer fake.sendMsgMutex.RUnlock()
	return len(fake.sendMsgArgsForCall)
}

func (fake *FakeCurrency_GetPriceStreamServer) SendMsgCalls(stub func(interface{}) error) {
	fake.sendMsgMutex.Lock()
	defer fake.sendMsgMutex.Unlock()
	fake.SendMsgStub = stub
}

func (fake *FakeCurrency_GetPriceStreamServer) SendMsgArgsForCall(i int) interface{} {
	fake.sendMsgMutex.RLock()
	defer fake.sendMsgMutex.RUnlock()
...
func (fake *FakeCurrency_GetPriceStreamServer) SendMsgReturns(result1 error) {
	fake.sendMsgMutex.Lock()
	defer fake.sendMsgMutex.Unlock()
...
func (fake *FakeCurrency_GetPriceStreamServer) SendMsgReturnsOnCall(i int, result1 error) {
	fake.sendMsgMutex.Lock()
	defer fake.sendMsgMutex.Unlock()
	fake.SendMsgStub = nil
...
func (fake *FakeCurrency_GetPriceStreamServer) SetHeader(arg1 metadata.MD) error {
...
func (fake *FakeCurrency_GetPriceStreamServer) SetHeaderCallCount() int {
	fake.setHeaderMutex.RLock()
	defer fake.setHeaderMutex.RUnlock()
	return len(fake.setHeaderArgsForCall)
}

func (fake *FakeCurrency_GetPriceStreamServer) SetHeaderCalls(stub func(metadata.MD) error) {
	fake.setHeaderMutex.Lock()
	defer fake.setHeaderMutex.Unlock()
	fake.SetHeaderStub = stub
}

func (fake *FakeCurrency_GetPriceStreamServer) SetHeaderArgsForCall(i int) metadata.MD {
	fake.setHeaderMutex.RLock()
	defer fake.setHeaderMutex.RUnlock()
...
func (fake *FakeCurrency_GetPriceStreamServer) SetHeaderReturns(result1 error) {
	fake.setHeaderMutex.Lock()
	defer fake.setHeaderMutex.Unlock()
...
func (fake *FakeCurrency_GetPriceStreamServer) SetHeaderReturnsOnCall(i int, result1 error) {
	fake.setHeaderMutex.Lock()
	defer fake.setHeaderMutex.Unlock()
	fake.SetHeaderStub = nil
...
func (fake *FakeCurrency_GetPriceStreamServer) SetTrailer(arg1 metadata.MD) {
...
func (fake *FakeCurrency_GetPriceStreamServer) SetTrailerCallCount() int {
	fake.setTrailerMutex.RLock()
	defer fake.setTrailerMutex.RUnlock()
	return len(fake.setTrailerArgsForCall)
}

func (fake *FakeCurrency_GetPriceStreamServer) SetTrailerCalls(stub func(metadata.MD)) {
	fake.setTrailerMutex.Lock()
	defer fake.setTrailerMutex.Unlock()
	fake.SetTrailerStub = stub
}

func (fake *FakeCurrency_GetPriceStreamServer) SetTrailerArgsForCall(i int) metadata.MD {
	fake.setTrailerMutex.RLock()
	defer fake.setTrailerMutex.RUnlock()
...
func (fake *FakeCurrency_GetPriceStreamServer) Invocations() map[string][][]interface{} {
...
func (fake *FakeCurrency_GetPriceStreamServer) recordInvocation(key string, args []interface{}) {
...
var _ v1.Currency_GetPriceStreamServer = new(FakeCurrency_GetPriceStreamServer)
